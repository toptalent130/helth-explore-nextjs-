                    ...
                    <div className="m-2">
                        <ul className="text-lg ml-3">
                          {data.jobs.map((each, key)=>{
                            return (
                              <div key={key}>
                                  <li className="m-4 h-10 hover:bg-gray-100" id={'parent_'+key} onClick={subitem}>
                                ...
                                <div id={ "child_"+key } className="hidden mt-5">
                                  { each.items.map((subitem, index)=>(
                                    <div key={index} className="ml-5 justify-between border-t py-4" id={"detail_parent"+key+"_"+index} onClick={showDetails}>
