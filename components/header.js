          ...
          {/* <div className="w-full" align="center"> */}
            ...
            >
              ...
              <ul className="flex flex-col lg:flex-row list-none" >
                <button className="border-2 rounded-md p-1 pl-2 pr-2 border-blue-600 text-blue-600">CREATE JOB</button>
                <div className="relative ml-20 inline-block">
                  ...
                  <span className="absolute left-7 top-0 text-xs inline-block p-0.5 box-border  h-7 w-7 border-4  border-gray-50 uppercase rounded-full text-gray-50 bg-red-600 uppercase last:mr-0 mr-1">2</span>
                </div>
